      ...
      <label className="relative inline-block h-[1.8em] w-[3.7em] text-[17px]">
        <input
          ...
          className={cn(
            ...
            "[&:checked+span:before]:bg-green-500",
        ...
        <span className={cn(
          ...
          "before:rounded-[20px] before:bg-white before:transition before:duration-300 before:content-['']",
          "before:shadow-[0_1px_2px_rgba(0,0,0,0.15)]"
        )} />
      </label>
    )
  }
