                  ...
                  {filteredPurchaseRequests.map((request) => (
                    <React.Fragment key={request.id}>
                      ...
                      {expandedRows[request.id] && (
                        <tr>
                          <td colSpan={(purchaseFilter === 'pending' ? 1 : 0) + 10 + (showPaymentLinkColumn ? 1 : 0)} className="px-4 py-2 bg-gray-50">
        ...
        <div className="fixed inset-0 bg-transparent bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-xl w-full max-w-md border border-gray-200 shadow-xl overflow-hidden">
            ...
            <div className="px-6 py-5 space-y-4">
              {/* URL Input */}
              <div>
                <label className="block text-sm font-medium text-black-700 mb-2">Payment URL (optional)</label>
                <input
                  type="text"
                  ...
                  try {
                    ...
                    if (paymentLinkPdf) {
                      ...
                      if (uploadData.filePath) {
                        ...
                        // API returns created content id — use our download route
